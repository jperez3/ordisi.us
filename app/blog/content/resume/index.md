...
- Developed reusable **Terraform modules** for VPC, IAM, and RDS provisioning, cutting infrastructure‑as‑code onboarding time by **93%** (15 days to 1 day).
- Led MySQL 5.7 to 8.0 migration using **RDS blue‑green deployments**, averting a projected **$560 k/yr** cost increase and achieving zero‑downtime cut‑overs.
...
### NationBuilder – Systems Engineer
_Los Angeles, CA August 2016-August 2019_
